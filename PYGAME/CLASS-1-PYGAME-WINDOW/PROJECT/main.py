...
text_my_rect = text_my.get_rect(center=(SCREEN_WIDTH//2 - 60, SCREEN_HEIGHT//2 + 120))
...
text_game_rect = text_game.get_rect(center=(SCREEN_WIDTH//2 + 20, SCREEN_HEIGHT//2 + 200))

text_screen = pygame.font.Font(None, 40).render("screen.", True, pygame.Color("white"))
text_screen_rect = text_screen.get_rect(center=(SCREEN_WIDTH//2 + 60, SCREEN_HEIGHT//2 + 240))
